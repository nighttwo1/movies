...
class SinglePageSource(val call: suspend (page: Int) -> TMDBMovies) : PagingSource<Int, Movie>() {
...
fun singlePager(call: suspend (page: Int) -> TMDBMovies) =
    Pager(PagingConfig(pageSize = perPage)) {
        SinglePageSource(call)
    }.flow
