...
public val MyIconPack.IcNewBox: ImageVector
    get() {
        if (_icNewBox != null) {
            return _icNewBox!!
        }
        _icNewBox = Builder(name = "IcNewBox", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp,
...
private var _icNewBox: ImageVector? = null
